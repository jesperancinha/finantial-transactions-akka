...
object Recipes {
  ...
  val startBeans: Event = Event("Start Beans", greenBeans, salt, flower, egg, pepper, oliveOil, water)
  val startBatter: Event = Event("Start Batter", greenBeans, salt, flower, egg, pepper, oliveOil, water)
